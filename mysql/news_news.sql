...
CREATE TABLE `news` (
  ...
  `source` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `weburl` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- Dump completed on 2020-07-25 14:12:05
